...
function run(targetOrgName) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            return axios_1.default.request(generateCreateRepoRequest(targetOrgName, targetRepoName, ghToken, isPrivate))
                .then(function () {
...
const targetOrgName = (_d = (_c = (_b = (_a = github_1.default === null || github_1.default === void 0 ? void 0 : github_1.default.context) === null || _a === void 0 ? void 0 : _a.payload) === null || _b === void 0 ? void 0 : _b.repository) === null || _c === void 0 ? void 0 : _c.owner) === null || _d === void 0 ? void 0 : _d.login;
!process.env.TEST && run(targetOrgName);
